...
import com.yunlan.kotlinutil.http.cookies.OkHttpCookies
...
class PersistentCookieStore internal constructor() {
    ...
    init {
        cookiePrefs = App.appContext.getSharedPreferences(COOKIE_PREFS, 0)
        cookies = HashMap()
    ...
    private fun decodeCookie(cookieString: String): Cookie? {
        ...
        try {
            ...
            cookie = (objectInputStream.readObject() as OkHttpCookies).cookies
        } catch (e: IOException) {
